...
public class CodeController {
    ...
    public AjaxResponseBody getWechatCode(@RequestBody Map<String,String> map){
        ...
        JSONObject tokenResult = CommonUtil.httpsRequest("https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid="+wxAppId+"&secret="+appSecret, "GET", null);
