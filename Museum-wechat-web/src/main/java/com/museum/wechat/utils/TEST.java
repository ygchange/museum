...
public class TEST {
    public static void main(String[] args) {
        ...
        JSONObject jsonObject1 = CommonUtil.httpsRequest("https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token="+s, "POST", "{\"action_name\": \"QR_LIMIT_SCENE\", \"action_info\": {\"scene\": {\"scene_id\": 123}}}");
